...
<body>
    <div class="container">
        <header>
            <nav>
                <div class="logo">
                    <img src="{{ asset('assets/images-removebg-preview.png') }}" alt="" />
                    <h3>Pengiriman Makanan & Minuman </h3>
                </div>
                </label>
                <ul>
        ...
        <main>
            <div class="jumbotron">
                <div class="jumbotron-text">
                    <h1>Temukan Makanan dan Minuman Lezat, Segar, dan Bergizi</h1>
                    <p>Jelajahi berbagai pilihan makanan dan minuman yang siap menggugah selera Anda</p>
                    <button type="button" class="btn_getStarted">Mulai</button>
                </div>
                <div class="jumbotron-img">
                    <img src="{{ asset('assets/pngtree-food-logo-png-image_5296974-removebg-preview.png') }}" alt="" />
                </div>
            </div>
                    ...
                    @foreach ($categories as $data)
                        <div class="card">
                            <div class="card-image">
                                <img src="{{ asset('assets/Untitled-removebg-preview.png' . $data->gambar) }}" alt="tidak ada gambar" />
                            </div>
        ...
        <footer>
            <h4>&copy; Pengiriman Makanan & Minuman</h4>
        </footer>
    </div>
    <script>
